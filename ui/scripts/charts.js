BugApp.Charts = {
    ...
    onlineUrl: 'ws://' + BugApp.Params.host + ':' + BugApp.Params.port + '/api/online/sla',
    ...
    renderSlaChart: function(chart, data, idx) {
        ...
        for (var i = idx; i < idx + 1; i++) {
            var legend = data.dataset[i].name;
            var values = data.dataset[i].values;
            dss.push({
                label: legend,
                data: values,
    ...
    renderBugsOutSlaChart: function(chart, data, idx1, idx2) {
        ...
        for (var i = 0; i < data.dataset.length; i++) {
            ...
            for (var j = 0; j < data.dataset[i].values.length; j++) {
